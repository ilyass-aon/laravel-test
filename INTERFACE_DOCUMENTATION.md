...
![Page d'accueil](./screen/Page_d'acceuille.png)
...
![Page d'inscription](./screen/Page_Inscription.png)
...
![Page de connexion](./screen/Page_login.png)
...
![Dashboard utilisateur](./screen/Page_dashboard.png)
...
![Page de réservation](./screen/Page_ReserverPropriete.png)
...
![Gestion des réservations](./screen/Page_reservation.png)
...
![Dashboard admin](./screen/Page_dashboardAdminPanel.png)
...
![Gestion propriétés admin](./screen/Page_ProprieteAdmin.png)
...
![Gestion réservations admin](./screen/Page_ResrvationAdmin.png)
...
![Dashboard admin panel](./screen/Page_dashboardPourAdmin.png)
...
![Suivi revenus admin](./screen/Page_RevenuAdmin.png)
